...
<div id="list-illustration" class="content scaffold-list" role="main">
    ...
    <div class="row">
        <g:each in="${illustrationList}" var="instance">
            <div class="col-md-auto" style="margin: 15px">
                <g:link controller="illustration" action="show" id="${instance.id}"><img
                        src="http://localhost:8081/assets/${instance.fileName}"
                        style="height: 150px; width: 150px;"/></g:link>
            </div>
        </g:each>
    </div>
