    ...
    <body>
        ...
        <div id="list-illustration" class="content scaffold-list" role="main">
            ...
            <table>
                <thead>
                <tr>
                    <th class="sortable"><a href="/user/index.gsp?sort=fileName&amp;max=10&amp;order=asc">File Name</a></th>
                    <th class="sortable"><a href="/user/index.gsp?sort=fileName&amp;max=10&amp;order=asc">Illustration</a></th>
                </tr>
                </thead>
                <g:each in="${illustrationList}" var="instance">
                    <tr>
                        <td><g:link controller="illustration" action="show" id="${instance.id}">${instance.fileName}</g:link></td>
                        <td><img src="http://localhost:8081/assets/${instance.fileName}"
