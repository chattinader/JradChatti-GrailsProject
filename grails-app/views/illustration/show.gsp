    ...
    <body>
        ...
        <div id="show-illustration" class="content scaffold-show" role="main">
            ...
            <div class="fieldcontain">
                ...
                <div class="property-value" aria-labelledby="fileName-label">${illustration.fileName}</div>
            </div>
            <div class="fieldcontain">
                <span id="file-label" class="property-label">Illustration</span>
                <div class="property-value" aria-labelledby="file-label">
